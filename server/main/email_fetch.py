...
from main.static_data import REDIRECT_URI, GOOGLE_ACCOUNTS_BASE_URL
from main.static_data import TEST_GOOGLE_REPLY, OK, FAIL, YIELD
from main.static_data import TEST_EMAIL_TEMPLATE
from main.models import WordUse, Word, WordsToLearn, InterestingEmail
